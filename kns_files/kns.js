...
$(function() {
	...
	Kns.palette = [
		...
		/* 0 */ {"0": {name: "Не выделяется", image: "+1"},"1": {name: "Кремовый", colour: "#f5e5ce"},"2": {name: "Белоснежный", colour: "#ffffff"},"3": {name: "Белый", colour: "#e6e6e6"},"4": {name: "Серебристый", colour: "#d1d1d1"},"5": {name: "Серый", colour: "#9e9e9e"},"6": {name: "Дымчатый", colour: "#5c5c5c"},"7": {name: "Чёрный", colour: "#242424"},"8": {name: "Угольно-чёрный", colour: "#141414"},"9": {name: "Иссиня-чёрный", colour: "#1d212c"},"10": {name: "Чернобурый", colour: "#2b1d1c"},"11": {name: "Бурый", colour: "#3d1c0b"},"12": {name: "Шоколадный", colour: "#6b3c28"},"13": {name: "Фавн", colour: "#9a715f"},"14": {name: "Медный", colour: "#bd6d32"},"15": {name: "Огненный", colour: "#cb4402"},"16": {name: "Красный", colour: "#e15c0f"},"17": {name: "Рыжий", colour: "#ed9b2d"},"18": {name: "Золотистый", colour: "#e5bd7f"},"19": {name: "Палевый", colour: "#d7ae98"},"20": {name: "Лиловый", colour: "#b19798"},"21": {name: "Голубой", colour: "#a6b4b7"},"22": {name: "Серо-голубой", colour: "#697a8a"},"23": {name: "Дымчато-голубой", colour: "#465165"},"24": {name: "Черничный", colour: "#323d51"}},
		/* ОСНОВНОЙ ЦВЕТ -- БАЗЫ */
		...
		/* УНИКАЛЬНЫЕ ОКРАСЫ */
		/* 11(3) */ {'0': {name: '', colour: ""},"1": {name: "Кремовый", colour: "#f5e5ce"},"2": {name: "Белоснежный", colour: "#ffffff"},"3": {name: "Белый", colour: "#e6e6e6"},"4": {name: "Серебристый", colour: "#d1d1d1"},"5": {name: "Серый", colour: "#9e9e9e"},"6": {name: "Дымчатый", colour: "#5c5c5c"},"7": {name: "Чёрный", colour: "#242424"},"8": {name: "Угольно-чёрный", colour: "#141414"},"9": {name: "Иссиня-чёрный", colour: "#1d212c"},"10": {name: "Чернобурый", colour: "#2b1d1c"},"11": {name: "Бурый", colour: "#3d1c0b"},"12": {name: "Шоколадный", colour: "#6b3c28"},"13": {name: "Фавн", colour: "#9a715f"},"14": {name: "Медный", colour: "#bd6d32"},"15": {name: "Огненный", colour: "#cb4402"},"16": {name: "Красный", colour: "#e15c0f"},"17": {name: "Рыжий", colour: "#ed9b2d"},"18": {name: "Золотистый", colour: "#e5bd7f"},"19": {name: "Палевый", colour: "#d7ae98"},"20": {name: "Лиловый", colour: "#b19798"},"21": {name: "Голубой", colour: "#a6b4b7"},"22": {name: "Серо-голубой", colour: "#697a8a"},"23": {name: "Дымчато-голубой", colour: "#465165"},"24": {name: "Черничный", colour: "#323d51"},"25": {name: "\r\nУникальный окрас", image: "+32"},"26": {name: "Уникальный окрас", image: "+33"},"27": {name: "Уникальный окрас", image: "+34"},"28": {name: "Уникальный окрас", image: "+35"},"29": {name: "Уникальный окрас", image: "+36"},"30": {name: "Уникальный окрас", image: "+37"},"31": {name: "Уникальный окрас", image: "+38"},"32": {name: "Уникальный окрас", image: "+39"},"33": {name: "Уникальный окрас", image: "+40"},"34": {name: "Уникальный окрас", image: "+41"},"35": {name: "Уникальный окрас", image: "+42"},"36": {name: "Уникальный окрас", image: "+43"},"37": {name: "Уникальный окрас", image: "+44"},"38": {name: "Уникальный окрас", image: "+45"},"39": {name: "Уникальный окрас", image: "+46"},"40": {name: "Уникальный окрас", image: "+47"},"41": {name: "Уникальный окрас", image: "+48"},"42": {name: "Уникальный окрас", image: "+49"},"43": {name: "Уникальный окрас", image: "+50"},"44": {name: "Уникальный окрас", image: "+51"},"45": {name: "Уникальный окрас", image: "+52"},"46": {name: "Уникальный окрас", image: "+53"}},
		/* ФИОЛЕТОВЫЕ ГЛАЗА */
